...
public class WalletController {
    ...
    public ResponseEntity<Double> checkWalletBalance(@PathVariable("userId") Long userId) {
        User user = userRepository.findById(userId)
                .orElseThrow(() -> new RuntimeException("User not found"));
    ...
    public ResponseEntity<Set<String>> getWalletCodes(@PathVariable("userId") Long userId) {
        User user = userRepository.findById(userId)
                .orElseThrow(() -> new RuntimeException("User not found"));
