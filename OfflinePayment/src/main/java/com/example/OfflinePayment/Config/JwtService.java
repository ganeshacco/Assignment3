...
public class JwtService {
    ...
    private static final String SECRET_KEY = "tnPWR5YW98k0cz82HmohLKqHowTfx3pDp1JclY4AhIwGWTvWR2YipiGW51XSjxOr\n";
    public String extractUser_name(String token) {
    ...
    public boolean isTokenValid(String token, UserDetails userDetails){
        final String username = extractUser_name(token);
